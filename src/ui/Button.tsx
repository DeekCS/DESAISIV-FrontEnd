...
const Button: FC<ButtonProps> = ({
  ...
  const buttonClasses = `${
    recipesStyle
      ? `bg-tertiary text-secondary hover:bg-secondary hover:text-tertiary hover:scale-105 mt-4 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-4 2xl:mt-4 rounded-md px-6 py-2 font-bold tracking-wider transition duration-300 ease-in-out transform cursor-pointer
      `
      : isSelected
